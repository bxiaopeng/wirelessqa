...
```
bixiaopeng@bixiaopengtekiMacBook-Pro Shell备忘录$ bash Shell学习总结之变量引用.sh
# -------------------------------------------------------
# =============  变量使用需知 ==========
# -------------------------------------------------------
# 1. 首个字符必须为字母（a-z，A-Z）
...
##例1. var被声明，值为OTHER
${var+i am other} #<- i am other

##例2. var没有被声明,值为空
${var_nono+i am other} #<-

##例3. var为空,值也为OTHER
${var_empty2+i am other} #<- i am other
...
##例2. var没有被声明,值为空
${var_nonono:+i am other} #<-

##例3. var为空,值为空
${var_empty3:+i am other} #<-

# ====== 引用格式:5. ${!varprefix*}:匹配之前所有以varprefix开头进行声明的变量

${!var*} #<- var var_empty var_empty2 var_empty3 var_no
